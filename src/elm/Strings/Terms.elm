...
terms_intro_part1 _ =
    "Welcome to https://app.compound.xyz, a website-hosted user interface (the “Interface” or “App”) provided by Compound Labs, Inc. (“we”, “our”, or “us”). The Interface provides access to a decentralized protocol on the Ethereum blockchain that allows suppliers and borrowers of certain digital assets to participate in autonomous interest rate markets (the “Protocol”)."


terms_intro_part2 : Translations.Lang -> String
terms_intro_part2 _ =
    "This Terms of Service Agreement (the “Agreement”) explains the terms and conditions by which you may access and use the Interface."


terms_intro_part3 : Translations.Lang -> String
terms_intro_part3 _ =
    " You must read this Agreement carefully."


terms_intro_part4 : Translations.Lang -> String
terms_intro_part4 _ =
...
terms_1_description _ =
    "We reserve the right, in our sole discretion, to modify this Agreement from time to time. If we make any modifications, we will notify you by updating the date at the top of the Agreement and by maintaining a current version of the Agreement at https://app.compound.xyz/terms. All modifications will be effective when they are posted, and your continued use of the Interface will serve as confirmation of your acceptance of those modifications. If you do not agree with any modifications to this Agreement, you must immediately stop accessing and using the Interface."
...
terms_2_description : Translations.Lang -> String
terms_2_description _ =
...
terms_3_description : Translations.Lang -> String
terms_3_description _ =
...
terms_5_description _ =
    "You agree not to engage in, or attempt to engage in, any of the following categories of prohibited activity in relation to your access and use of the Interface:"


terms_5_bullet_a_title : Translations.Lang -> String
terms_5_bullet_a_title _ =
    "Intellectual Property Infringement"


terms_5_bullet_a_descriptiopn : Translations.Lang -> String
terms_5_bullet_a_descriptiopn _ =
...
terms_5_bullet_b_title : Translations.Lang -> String
terms_5_bullet_b_title _ =
    "Cyberattack"


terms_5_bullet_b_descriptiopn : Translations.Lang -> String
terms_5_bullet_b_descriptiopn _ =
...
terms_5_bullet_c_title : Translations.Lang -> String
terms_5_bullet_c_title _ =
    "Fraud and Misrepresentation"


terms_5_bullet_c_descriptiopn : Translations.Lang -> String
terms_5_bullet_c_descriptiopn _ =
...
terms_5_bullet_d_title : Translations.Lang -> String
terms_5_bullet_d_title _ =
    "Market Manipulation"


terms_5_bullet_d_descriptiopn : Translations.Lang -> String
terms_5_bullet_d_descriptiopn _ =
...
terms_5_bullet_e_title : Translations.Lang -> String
terms_5_bullet_e_title _ =
    "Any Other Unlawful Conduct"


terms_5_bullet_e_descriptiopn : Translations.Lang -> String
terms_5_bullet_e_descriptiopn _ =
...
terms_7_description_part2 : Translations.Lang -> String
terms_7_description_part2 _ =
    " You acknowledge and agree that your use of the Interface is at your own risk."


terms_7_description_part3 : Translations.Lang -> String
terms_7_description_part3 _ =
...
terms_10_description_part2 : Translations.Lang -> String
terms_10_description_part2 _ =
...
terms_15_description_part1 _ =
    "We will use our best efforts to resolve any potential disputes through informal, good faith negotiations. If a potential dispute arises, you must contact us by sending an email to legal@comp.xyz so that we can attempt to resolve it without resorting to formal dispute resolution. If we aren’t able to reach an informal resolution within sixty days of your email, then you and we both agree to resolve the potential dispute according to the process set forth below."


terms_15_description_part2 : Translations.Lang -> String
terms_15_description_part2 _ =
    "Any claim or controversy arising out of or relating to the Interface, this Agreement, or any other acts or omissions for which you may contend that we are liable, including (but not limited to) any claim or controversy as to arbitrability (“Dispute”), shall be finally and exclusively settled by arbitration under the JAMS Optional Expedited Arbitration Procedures."


terms_15_description_part3 : Translations.Lang -> String
terms_15_description_part3 _ =
    " You understand that you are required to resolve all Disputes by binding arbitration."
